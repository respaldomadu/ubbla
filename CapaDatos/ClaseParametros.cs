   ...
   public class ClaseParametros
    {
        ...
        //Constructor
        public ClaseParametros(String ObjNombre,Object objValor) {
            m_Nombre = ObjNombre;
            m_Valor = objValor;
            m_Direccion = ParameterDirection.Input;
        }

        public ClaseParametros(String objNombre, Object objValor, SqlDbType objTipoDato, ParameterDirection objDireccion, int objTamaño)
        {
            m_Nombre = objNombre;
            m_Valor = objValor;
